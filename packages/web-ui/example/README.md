# PI Studio Web UI Example

This is a minimal example showing how to use the PI Studio web UI package (`@mariozechner/pi-web-ui`) in a web application.
...
- [PI Studio Web UI Documentation](../README.md)
